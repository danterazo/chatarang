            ...
            Chatarang
				...
				<main className={css(styles.main)}>
					<form className={css(styles.form)} onSubmit={this.handleSubmit}>
						...
						<label htmlFor="displayName" className={css(styles.label)}>
							Display Name (optional)
						</label>
						<input autoFocus type="text" name="displayName"
							   className={css(styles.input)}
						...
						<input required type="password" name="password"
							   ...
							   onChange={this.handleChange}/>
						<label htmlFor="passwordConfirmation" className={css(styles.label)}>
							Re-type Password
						</label>
